...
**Vet Clinic Database** is a database about animals brought for treatment in the clinic. This project is based on PostgreSQL.
...
- **More complex relations will be added for the better assessment of animals**
...
Feel free to check the [issues page](https://github.com/sameedmohsin28/Vet-Clinic-Database/issues).
...
I would like to thank Microverse for teaching me PostgreSQL.
